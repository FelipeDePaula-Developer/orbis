...
public interface PhoneServicesInterface extends ValidateServices {
    ...
    default Map<String, String> validatePhones(List<PhoneNumber> phoneNumbers) {
        ...
        for (PhoneNumber phoneNumber : phoneNumbers) {
            Map<String, String> singlePhoneErrors = validateSinglePhone(phoneNumber);
            ret.putAll(singlePhoneErrors);
        }

        return ret;
    }

    default Map<String, String> validateSinglePhone(PhoneNumber phoneNumber) {
        Map<String, String> ret = new HashMap<>();
